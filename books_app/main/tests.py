...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='John Doe').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'John Doe')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Spooky').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'Spooky')
